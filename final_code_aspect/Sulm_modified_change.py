...
#        self.frame.pack()
    ...
    def new_window2(self):
        self.newWindow = tk.Toplevel(self.master)
        self.app = Demo7(self.newWindow,self.txte+10,self.mdl)
    def new_window3(self):
        self.newWindow = tk.Toplevel(self.master)
        self.app = Demo8(self.newWindow,self.txte+20,self.mdl)
    def new_window4(self):
        self.newWindow = tk.Toplevel(self.master)
        self.app = Demo9(self.newWindow,self.txte+30,self.mdl)
